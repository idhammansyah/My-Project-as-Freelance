...
<html lang="en">
    <head>
        <title>Tribest Accessories - Home</title>
        <meta charset="utf-8">
        <meta
            name="viewport"
        ...
        <div class="container-fluid" style="border: 10px; background-color: #b0c7bd;">
            <div class="row">
                <div class="col-md-4 col-lg-2 ftco-animate">
                    <div class="product">
                        <a href="shop.php" class="img-prod"><img class="img-fluid" src="img/shockbreakerr.png" alt="Tribest">
                            <div class="overlay"></div>
                        </a>
                ...
                <div class="col-md-4 col-lg-2 ftco-animate">
                    <div class="product">
                        <a href="shop.php" class="img-prod"><img class="img-fluid" src="img/klaksonn.png" alt="Tribest">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3>
                ...
                <div class="col-md-4 col-lg-2 ftco-animate">
                    <div class="product">
                        <a href="shop.php" class="img-prod"><img class="img-fluid" src="img/spionn.png" alt="Tribest">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3>
                ...
                <div class="col-md-4 col-lg-2 ftco-animate">
                    <div class="product">
                        <a href="shop.php" class="img-prod"><img class="img-fluid" src="img/lampu.png" alt="TriBest">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3>
                ...
                <div class="col-md-4 col-lg-2 ftco-animate">
                    <div class="product">
                        <a href="shop.php" class="img-prod"><img class="img-fluid" src="img/handgripp.png" alt="TriBest">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3>
    ...
    <section class="ftco-section" style="background-color: whitesmoke;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-4 ftco-animate">
                    <div class="product">
                        <a href="#" class="img-prod"><img class="img-fluid" src="img/starss.png" alt="Rating">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3>
